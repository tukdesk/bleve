...
func TestRows(t *testing.T) {
	tests := []struct {
		...
		// test vectors with arrayPositions
		{
			...
			[]byte{'t', 0, 0, 'b', 'e', 'e', 'r', ByteSeparator, 'b', 'u', 'd', 'w', 'e', 'i', 's', 'e', 'r'},
			[]byte{168, 202, 1, 195, 235, 163, 130, 4, 255, 1, 1, 3, 11, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 1, 0, 0, 150, 17, 23, 31, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 2, 1, 2, 0, 3, 43, 51, 255, 255, 255, 255, 255, 255, 255, 255, 255, 255, 3, 3, 4, 5},
		},
		{
